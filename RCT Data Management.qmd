...
FINAL_DATA$province_screen_label <- recode(FINAL_DATA$province_screen, 
                                   '1' = 'British Columbia',
                                   '2' = 'Alberta',
                                   '3' = 'Saskatchewan',
                                   '4' = 'Manitoba',
...
# Gender
FINAL_DATA$gender_label <- recode(FINAL_DATA$gender,
                                  '1'	= 'Male',
                                  '2' =	'Female',
...
# Race
FINAL_DATA$race_label <- recode(FINAL_DATA$race,
                                '1' =	'White',
                                '2' =	'South Asian',
                                '3' =	'Black',
...
# Income
FINAL_DATA$income_label <- recode(FINAL_DATA$incom,
                                  '1'	= 'Less than $20,000',
...
# Education
FINAL_DATA$education_label <- recode(FINAL_DATA$edu,
...
# Invitation source
FINAL_DATA$invite_label <- recode(FINAL_DATA$invite,
